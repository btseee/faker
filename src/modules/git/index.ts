...
export class GitModule extends ModuleBase {
   ...
   */
  branch(): string {
    return gitBranch(fakerToCore(this.faker));
  }
  ...
  commitEntry(
    ...
    return gitCommitEntry(fakerToCore(this.faker), options);
  }
  ...
  commitMessage(): string {
    return gitCommitMessage(fakerToCore(this.faker));
  }
   ...
   * @param options.refDate The date to use as reference point for the commit. Defaults to `faker.getDefaultRefDate()`.
   *
   * @example
  ...
  commitDate(
    ...
    return gitCommitDate(fakerToCore(this.faker), options);
  }
  ...
  commitSha(
    ...
    return gitCommitSha(fakerToCore(this.faker), options);
  }
}
