...
export class FinanceModule extends ModuleBase {
  ...
  accountNumber(
    ...
    return financeAccountNumber(fakerToCore(this.faker), options);
  }
   ...
   */
  accountName(): string {
    return financeAccountName(fakerToCore(this.faker));
  }
  ...
  routingNumber(): string {
    return financeRoutingNumber(fakerToCore(this.faker));
  }
  ...
  amount(
    ...
    return financeAmount(fakerToCore(this.faker), options);
  }
  ...
  transactionType(): string {
    return financeTransactionType(fakerToCore(this.faker));
  }
   ...
   */
  currency(): Currency {
    return financeCurrency(fakerToCore(this.faker));
  }
   ...
   */
  currencyCode(): string {
    return financeCurrencyCode(fakerToCore(this.faker));
  }
   ...
   */
  currencyName(): string {
    return financeCurrencyName(fakerToCore(this.faker));
  }
  ...
  currencySymbol(): string {
    return financeCurrencySymbol(fakerToCore(this.faker));
  }
  ...
  currencyNumericCode(): string {
    return financeCurrencyNumericCode(fakerToCore(this.faker));
  }
  ...
  bitcoinAddress(
    ...
    return financeBitcoinAddress(fakerToCore(this.faker), options);
  }
  ...
  litecoinAddress(): string {
    return financeLitecoinAddress(fakerToCore(this.faker));
  }
  ...
  creditCardNumber(
    ...
    return financeCreditCardNumber(fakerToCore(this.faker), options);
  }
  ...
  creditCardCVV(): string {
    return financeCreditCardCVV(fakerToCore(this.faker));
  }
  ...
  creditCardIssuer(): string {
    return financeCreditCardIssuer(fakerToCore(this.faker));
  }
  ...
  pin(
    ...
    return financePin(fakerToCore(this.faker), options);
  }
  ...
  ethereumAddress(): string {
    return financeEthereumAddress(fakerToCore(this.faker));
  }
  ...
  iban(
    ...
    return financeIban(fakerToCore(this.faker), options);
  }
  ...
  bic(
    ...
    return financeBic(fakerToCore(this.faker), options);
  }
  ...
  transactionDescription(): string {
    return financeTransactionDescription(fakerToCore(this.faker));
  }
}
