...
export class StringModule extends SimpleModuleBase {
  ...
  fromCharacters(
    ...
    return stringFromCharacters(fakerToCore(this.faker), characters, length);
  }
  ...
  alpha(
    ...
    return stringAlpha(fakerToCore(this.faker), options);
  }
  ...
  alphanumeric(
    ...
    return stringAlphanumeric(fakerToCore(this.faker), options);
  }
  ...
  binary(
    ...
    return stringBinary(fakerToCore(this.faker), options);
  }
  ...
  octal(
    ...
    return stringOctal(fakerToCore(this.faker), options);
  }
  ...
  hexadecimal(
    ...
    return stringHexadecimal(fakerToCore(this.faker), options);
  }
  ...
  numeric(
    ...
    return stringNumeric(fakerToCore(this.faker), options);
  }
  ...
  sample(
    ...
    return stringSample(fakerToCore(this.faker), length);
  }
   ...
   * Defaults to `faker.getDefaultRefDate()`.
   *
   * @example
  ...
  uuid(
    ...
    return stringUuid(fakerToCore(this.faker), options);
  }
  ...
  ulid(
    ...
    return stringUlid(fakerToCore(this.faker), options);
  }
  ...
  nanoid(
    ...
    return stringNanoid(fakerToCore(this.faker), length);
  }
  ...
  symbol(
    ...
    return stringSymbol(fakerToCore(this.faker), length);
  }
}
